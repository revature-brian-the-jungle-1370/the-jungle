...
#     comment_dao.create_comment = MagicMock(return_value="thisisareturnvalue")
#     try:
#         comment_service.service_create_comment(post_id= 1000, user_id= 1000, comment_text=1000, group_id=1000, reply_user=1000)
#         assert False
#     except CommentMustBeAString as e:
#         assert str(e) == "Comment must be a string."
...
#         assert str(e) == "Post ID must be an integer."   
