Feature: Users can view different groups

  Scenario: User can visit each group page on the Groups panel
  ...
  Scenario: User can visit each group page on the My Groups panel
    Given the user is on the main group page
  ...
  Scenario: User can visit the groups page
    Given the user is on the main group page
