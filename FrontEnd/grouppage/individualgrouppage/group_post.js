...
async function createGroupPost() {
  ...
  let data = {
    ...
    "group_id": Number(localStorage.getItem("groupId")), //was sessionStorage.getItem("group_id")),
    //"user_id": 9000, //commented this 2
    //"group_id": 9000,
    "post_text": post_text,
    "image_data": "",
    "likes": 0,
...
async function getPost() {
  ...
  let response = await fetch(url + "/group_post/group/" + group_id, {// replaced "/group_post/group/9000" //replace with "/group_post/group/" + group_id
    method: "GET",
    mode: "cors",
  });
